...
public class ListUsersActivity extends Activity {
    ...
    public static ArrayList<QBUser> getUsers() {
        return users;
    }
         ...
         btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (QBUser usr : users) {
                    if (usr.getFullName().equals(userName.getText())) {
                        initialLoggedIn(usr.getId());
                        break;
                    }
                }
    ...
    private void createAppSession() {
        ...
        QBAuth.createSession(new QBEntityCallback<QBSession>() {
            ...
            //                Toast.makeText(ListUsersActivity.this, " loading users success", Toast.LENGTH_SHORT).show();
    ...
    private void loadUsers(String tag){
        ...
        QBUsers.getUsersByTags(tags, requestBuilder, new QBEntityCallbackImpl<ArrayList<QBUser>>() {
            ...
            public void onSuccess(ArrayList<QBUser> qbUsers, Bundle bundle) {
              ...
              //  Toast.makeText(ListUsersActivity.this, "Get User by tag", Toast.LENGTH_SHORT).show();
    ...
    public  void initialLoggedIn(int position){
        {
            if (!resultReceived || (SystemClock.uptimeMillis() - upTime) < ON_ITEM_CLICK_DELAY){
                return;
            }
